...
export const mockQuestionBank = {
    ...
    algorithms: [
        ...
        },
        {
            ...
            a: 'DP breaks a problem into overlapping subproblems and solves each once, storing results (memoization top-down or tabulation bottom-up). It applies when there\'s optimal substructure + overlapping subproblems. Example: Fibonacci goes from O(2ⁿ) recursion to O(n) with memo.',
...
export const skillKeywords = [
    ...
    'Docker', 'Kubernetes', 'Git', 'REST API', 'GraphQL', 'CI/CD', 'Agile',
    'Leadership', 'Communication', 'Problem Solving', 'Teamwork', 'Testing',
    'Microservices', 'PostgreSQL', 'MongoDB', 'Redis', 'Linux',
];
